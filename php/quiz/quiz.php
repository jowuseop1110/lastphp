...
<?php
    ...
    <main id="contents">
        ...
        <section id="quiz-type" class="section center gray">
            <div class="container">
                <h3 class="section__title"><span></span> 퀴즈</h3>
                ...
                <div class="quiz__inner">
                    ...
                    <div class="quiz__footer">
                        <div class="quiz__btn">
                            <button class="comment Rainy none"><span>해설보기</span></button>
                            <button class="next Frozen ml10 right none">다음 문제</button>
                            <button class="confirm Lady ml10 right">정답 확인</button>  
                            <div class="comment_modal" title="여기를 클릭하면 창이 닫힙니다."><span></span></div>                       
                        </div>
...
<?php
    ...
    <script>
        ...
        function quizView(view){
            ...
            $("#select4 + span").text(view.quizChoice4);
            $(".comment_modal span").text(view.quizComment);
        ...
        //해설보기 버튼을 클릭하면 모달창 열기
        document.querySelector(".quiz__btn .comment").addEventListener("click", () => {
            document.querySelector(".quiz__btn .comment").classList.add("modal", "show")
            document.querySelector(".comment_modal").classList.add("show")
        })
        document.querySelector(".quiz__btn .comment_modal").addEventListener("click", () => {
            document.querySelector(".quiz__btn .comment").classList.remove("modal" ,"show");
            document.querySelector(".comment_modal").classList.remove("show")
        })
